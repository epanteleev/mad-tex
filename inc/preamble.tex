...
\hypersetup{
    ...
    pdfauthor={Пантелеев Евгений},
    pdftitle={Эффективная реализация сопрограмм в управляемой среде исполнения.}
}
...
\titleformat{\section}{}{}{12.5mm}{\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{1em}}
